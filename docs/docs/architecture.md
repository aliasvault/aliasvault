...
You can also view the diagram in a browser-friendly HTML format: [AliasVault Security Architecture](pathname:///assets/diagrams/security-architecture/aliasvault-security-architecture.html)
