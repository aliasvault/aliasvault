/**
 * Password length slider with non-linear scaling: a power curve gives fine-grained control at the lengths most
 * users pick (12-32) and coarser control at the long end (64-256).
 */
