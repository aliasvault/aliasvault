...
export default defineBackground({
  ...
  main() {
    ...
    onMessage('GROUP_GRANT_ACCESS', ({ data, sender }) => isTrustedExtensionSender(sender) ? handleGroupGrantAccess(data) : { success: false });
    onMessage('GROUP_REVOKE_ACCESS', ({ data, sender }) => isTrustedExtensionSender(sender) ? handleGroupRevokeAccess(data) : { success: false });
    onMessage('GROUP_REMOVE_MEMBER', ({ data, sender }) => isTrustedExtensionSender(sender) ? handleGroupRemoveMember(data) : { success: false });
