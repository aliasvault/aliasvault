...
function getAppIconSvg(key) {
  return Object.prototype.hasOwnProperty.call(AppIconSvgs, key) ? AppIconSvgs[key] : null;
}
function getAllAppIconKeys() {
  return Object.keys(AppIconSvgs);
}

export { AppIconSvgs, ItemTypeIconSvgs, getAllAppIconKeys, getAllIconKeys, getAppIconSvg, getItemTypeIconSvg };
