...
This archive contains the source code of the AliasVault browser extension as submitted to
addons.mozilla.org, together with the shared packages that the extension is built from. It mirrors the
layout of the public repository at https://github.com/aliasvault/aliasvault, which also holds the
server and mobile app sources that are not needed to build the extension.
