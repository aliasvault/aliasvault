 ...
 */
declare function getAppIconSvg(key: string): string | null;
/**
 * Get all built-in icon keys, in the order they are offered to the user.
 */
declare function getAllAppIconKeys(): AppIconKey[];

export { type AppIconKey, AppIconSvgs, type ItemTypeIconKey, ItemTypeIconSvgs, getAllAppIconKeys, getAllIconKeys, getAppIconSvg, getItemTypeIconSvg };
