...
const SmallLoadingIndicator: React.FC<SmallLoadingIndicatorProps> = ({ title = '', spinning = true, children }) => (
  <div role="status" className="px-2 flex items-center" title={title}>
    <div className="relative inline-flex items-center justify-center">
      {children}
      <svg aria-hidden="true" className={`inline w-8 h-8 text-gray-200 ${spinning ? 'animate-spin fill-primary-600' : ''} dark:text-gray-600`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
