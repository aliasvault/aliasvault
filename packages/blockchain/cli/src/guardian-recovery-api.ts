...
import {
  type GuardianRecoveryProviders,
  type DeployedGuardianRecoveryContract,
} from './guardian-recovery-types';
import path from 'node:path';
import { currentDir } from './config';

let logger: Logger;

export const guardianRecoveryZkConfigPath = path.resolve(currentDir, '..', '..', 'contract', 'src', 'managed', 'guardian-recovery');
...
export const claimRecovery = async (
  contract: DeployedGuardianRecoveryContract,
): Promise<void> => {
